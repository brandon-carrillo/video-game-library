...
public class MyLibraryAdapter extends RecyclerView.Adapter<GameViewHolder> {
    // constants
    private static final String LOG_TAG = MyLibraryAdapter.class.getSimpleName();
    ...
    public MyLibraryAdapter(AppCompatActivity context, MyProfileViewModel model) {
