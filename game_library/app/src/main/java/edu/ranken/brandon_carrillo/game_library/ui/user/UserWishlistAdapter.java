...
public class UserWishlistAdapter extends RecyclerView.Adapter<GameViewHolder> {
    // constants
    private static final String LOG_TAG = UserWishlistAdapter.class.getSimpleName();
    ...
    public UserWishlistAdapter(Activity context, UserProfileViewModel model) {
...
//        Map<String, Boolean> lib = model.getLibrary().getValue().get(position).platforms;
